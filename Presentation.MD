...
```solidity
uint256 sharesToIssue = amt * totalSupply / totalAssets; /// @audit / is integer division
```

Because (ℤ, //) is not a group, we don't have the reversibility of operations as a guarantee.
